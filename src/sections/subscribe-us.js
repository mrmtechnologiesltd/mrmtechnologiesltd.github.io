...
const SubscribeUs = () => {
  ...
  return (
    <Box id="career" as="section" sx={styles.section} variant="section.subscribe">
      <Container>
        <Box sx={styles.contentWrapper}>
          <SectionHeading
            sx={styles.heading}
            title="Interested in working with us?"
            description="Currently we do not have any open role. If you are interested in what you read, Please contact us on on hr@mrmtech.co.uk"
          />
{/*           
